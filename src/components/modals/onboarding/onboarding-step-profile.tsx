...
export function OnboardingStepProfile({
  ...
  const nicknameValid = nicknameStatus === "available";
    ...
    <>
      ...
      <div className="flex justify-center">
        <label className="relative cursor-pointer">
          <Avatar className="size-20 border border-input">
            {avatarPreview && <AvatarImage src={avatarPreview} alt="프로필 미리보기" />}
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="onboarding-nickname" className="text-title-1 text-text-primary">
          닉네임
        </label>
        <Input
